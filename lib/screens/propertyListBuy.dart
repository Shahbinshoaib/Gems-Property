...
class PropertyListBuy extends StatefulWidget {
  @override
  _PropertyListBuyState createState() => _PropertyListBuyState();
}

class _PropertyListBuyState extends State<PropertyListBuy> {
  ...
  Widget build(BuildContext context) {
    ...
    final property2 = property.reversed;


    return property2.length != 0 ? Container(
      child: Column(
        children: [
          Padding(
            ...
            child: ButtonTheme(
              ...
              child: RaisedButton(
                onPressed: (){
                  showSearch(
                    context: context,
                    delegate: CustomSearchDelegate(property: property),
                  );
                },
                elevation: 5.0,
           ...
           Container(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index){
                if(_filterUsed){
                  if(property2.toList()[index].type.toUpperCase() == _fType || property2.toList()[index].bedrooms == _beds || (double.parse(property2.toList()[index].price) >= _currentRangeValues.start && double.parse(property2.toList()[index].price).toDouble() <= _currentRangeValues.end)) {
                    return Padding(
                          ...
                          Container(
                            ...
                            child: Card(
                                ...
                                child: Column(
                                  children: [
                                    ClipRRect(
                                      child: Image.network(property2.toList()[index].pic ?? 'https://cdn.dribbble.com/users/3638706/screenshots/10188432/db2-01.jpg',height: h*0.35,fit: BoxFit.fill,),
                                      borderRadius: BorderRadius.circular(20.0)   ,),
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Column(
                                            ...
                                            children: [
                                              Text(property2.toList()[index].title,style: TextStyle(fontWeight: FontWeight.bold,fontSize: h*0.016,color: Colors.black),),
                                              SizedBox(height: h*0.01,),
                                              Text('Rs.${property2.toList()[index].price} Crore',style: TextStyle(fontSize: h*0.016,color: Colors.black45),),
                                              SizedBox(height: h*0.01,),
                                              Text(property2.toList()[index].type,style: TextStyle(fontSize: h*0.016,color: Colors.black45),),
                                              SizedBox(height: h*0.01,),
                                              Text('Property ID: ${property2.toList()[index].id}',style: TextStyle(fontSize: h*0.016,color: Colors.indigo),),
                                            ],
                                          ),
                                          RaisedButton(
                                            color: Colors.orange,
                                            ...
                                            onPressed: () {
                                              ...
                                              Navigator.of(context).push(AdminPanel1(property2.toList()[index]));
                                              setState(() {
                                                loader = false;
                                              });
                                            },
            ...
            actions: <Widget>[
              ...
              FlatButton(
                ...
                onPressed: () async {
                  ...
                  Navigator.pop(context);
                  await DatabaseService().delBuyPropertyDocument(property.id);
                },
              ),
            ],
          );
